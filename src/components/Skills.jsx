      ...
      <div className="container px-5 relative mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 justify-items-center">
          {skills.skills_content.map((skill, i) => (
            <div
              key={i}
              className="w-full bg-white cursor-pointer relative group flex flex-col items-center justify-center gap-5 p-5 max-w-sm rounded-md border-2 border-slate-200"
            >
              <img
                src={skill.logo}
                alt="Skill Logo"
                className="w-20 group-hover:scale-125 duration-200 aspect-square"
              />
